...
public class PhotoView extends ImageView implements IPhotoView,
	...
	protected void init() {
		...
		if (mDraweeHolder == null) {
			GenericDraweeHierarchy hierarchy = new GenericDraweeHierarchyBuilder(
					getResources()).setFadeDuration(300)
	...
	public PhotoView setImageDownloadListener(
			ImageDownloadListener mDownloadListener) {
	...
	public void setImageUri(String url) {
		...
		DraweeController controller = Fresco.newDraweeControllerBuilder()
				...
				.setControllerListener(new BaseControllerListener<ImageInfo>() {
					@Override
					public void onFinalImageSet(String s, ImageInfo imageInfo,
