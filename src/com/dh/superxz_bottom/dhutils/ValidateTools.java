...
/**
 * @Description 相关正则验证工具类
 * @Author czo
 * @Class ValidateTools
 * @Date 2015-11-30 10:30:33
 */
public abstract class ValidateTools {
    ...
    // 正则，以字母汉字开头不含有特殊字符
    private static final String ONLY_NUM_CHACTER = "^[\\u4e00-\\u9fa5a-zA-Z][^%&',-;=?$\\x22]+";
    ...
    /**
     * 是否为汉字字母开头 不含有特殊字符是:返回true 否:返回false
     */
    public static boolean ishanzi(String string) {
	return matcher(string, ONLY_NUM_CHACTER);
    }
