...
import static com.dh.superxz_bottom.alibaba.fastjson.util.ASMUtils.getDesc;
import static com.dh.superxz_bottom.alibaba.fastjson.util.ASMUtils.getType;
...
import com.dh.superxz_bottom.alibaba.fastjson.asm.ClassWriter;
import com.dh.superxz_bottom.alibaba.fastjson.asm.FieldVisitor;
import com.dh.superxz_bottom.alibaba.fastjson.asm.Label;
import com.dh.superxz_bottom.alibaba.fastjson.asm.MethodVisitor;
import com.dh.superxz_bottom.alibaba.fastjson.asm.Opcodes;
...
import com.dh.superxz_bottom.alibaba.fastjson.parser.JSONScanner;
...
import com.dh.superxz_bottom.alibaba.fastjson.parser.SymbolTable;
import com.dh.superxz_bottom.alibaba.fastjson.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
import com.dh.superxz_bottom.alibaba.fastjson.util.ASMClassLoader;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.dh.superxz_bottom.alibaba.fastjson.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultExtJSONParser.class), "getConfig",
                           "()" + getDesc(ParserConfig.class));
        mw.visitLdcInsn(com.dh.superxz_bottom.alibaba.fastjson.asm.Type.getType(getDesc(fieldInfo.getMethod().getParameterTypes()[0])));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(ParserConfig.class), "getDeserializer",
                           "(" + getDesc(Type.class) + ")" + getDesc(ObjectDeserializer.class));
